...
INSERT INTO Title 
 ...
 #Write an SQL query to fetch “FIRST_NAME”
...
#Write an SQL query that fetches the unique values 
...
Select REPLACE(FIRST_NAME,'a','A') from Worker;
 ...
 #Write an SQL query to print details for Workers with the 
...
Select * from Worker where FIRST_NAME like '%a%';
 ...
 #Write an SQL query to print details of the Workers 
 ...
 #Write an SQL query to fetch worker names with 
...
# Write an SQL query to fetch the no. of workers 
...
#Write an SQL query to fetch duplicate
